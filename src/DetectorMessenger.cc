...
{ 
  ...
  ChamberDir->SetGuidance("UI commands");
  
  detDir = new G4UIdirectory("/Chamber/det/");
  detDir->SetGuidance("detector control");
       
  AbsMaterCmd = new G4UIcmdWithAString("/Chamber/det/setAbsMat",this);
  AbsMaterCmd->SetGuidance("Select Material of the Absorber.");
  AbsMaterCmd->SetParameterName("choice",false);
  AbsMaterCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
  
  GapMaterCmd = new G4UIcmdWithAString("/Chamber/det/setGapMat",this);
  ...
  AbsThickCmd = new G4UIcmdWithADoubleAndUnit("/Chamber/det/setAbsThick",this);
  ...
  GapThickCmd = new G4UIcmdWithADoubleAndUnit("/Chamber/det/setGapThick",this);
  ...
  SizeYZCmd = new G4UIcmdWithADoubleAndUnit("/Chamber/det/setSizeYZ",this);
  ...
  NbLayersCmd = new G4UIcmdWithAnInteger("/Chamber/det/setNbOfLayers",this);
  ...
  UpdateCmd = new G4UIcmdWithoutParameter("/Chamber/det/update",this);
  UpdateCmd->SetGuidance("Update calorimeter geometry.");
  UpdateCmd->SetGuidance("This command MUST be applied before \"beamOn\" ");
  UpdateCmd->SetGuidance("if you changed geometrical value(s).");
  UpdateCmd->AvailableForStates(G4State_Idle);
      
  MagFieldCmd = new G4UIcmdWithADoubleAndUnit("/Chamber/det/setField",this);  
